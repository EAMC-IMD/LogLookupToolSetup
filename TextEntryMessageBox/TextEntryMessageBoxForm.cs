...
namespace SapphTools.Utils.UX {
    ...
    /// </summary>
    internal partial class TextEntryMessageBoxForm : Form {
        #region Constants
        ...
        private TextEntryMessageBoxButton _cancelButton = null;
        ...
        private TimeoutResult _timeoutResult = UX.TimeoutResult.Default;
        ...
        public TextEntryMessageBoxButton CustomCancelButton {
        ...
        #region Ctor/Dtor
        public TextEntryMessageBoxForm() {
            //
        ...
        protected override void OnLoad(EventArgs e) {
            ...
            //_maxLayoutHeight = ClientSize.Height - TOP_PADDING - BOTTOM_PADDING;
        ...
        private string GetLongestButtonText() {
            int maxLen = 0;
            string maxStr = null;
            foreach (TextEntryMessageBoxButton button in _buttons) {
        ...
        private void SetInputSize() {
            const int height = 24;
            if (_inputWidth == 0) {
                _inputWidth = rtbMessage.Size.Width;
            }
            int width = Math.Min(_maxLayoutWidth, _inputWidth);
            inputBox.Size = new Size(width, height);
            inputBox.MaxLength = InputMaxLength;
        }
        /// <summary>
        ...
        private void AddOkButtonIfNoButtonsPresent() {
            if (_buttons.Count == 0) {
                TextEntryMessageBoxButton okButton = new TextEntryMessageBoxButton {
                    Text = TextEntryMessageBoxButtons.Ok.ToString(),
                    Value = TextEntryMessageBoxButtons.Ok.ToString()
                };
        ...
        private void SetOptimumSize() {
            ...
            int saveResponseRowWidth = inputBox.Width + (int)(panelIcon.Width / 2);
            ...
            int requiredHeight = TOP_PADDING + Math.Max(rtbMessage.Height, panelIcon.Height) + ITEM_PADDING + inputBox.Height + ITEM_PADDING + inputBox.Height + ITEM_PADDING + GetButtonSize().Height + BOTTOM_PADDING + ncHeight;
        ...
        private Size GetCaptionSize() {
            Font captionFont = GetCaptionFont() ?? new Font("Tahoma", 11);
        ...
        private void LayoutControls() {
            ...
            inputBox.Location = new Point(LEFT_PADDING + (int)(panelIcon.Width / 2),
                TOP_PADDING + Math.Max(panelIcon.Height, rtbMessage.Height) + ITEM_PADDING);

            Size buttonSize = GetButtonSize();
            int allButtonsWidth = GetWidthOfAllButtons();

            int firstButtonX = ((int)(ClientSize.Width - allButtonsWidth) / 2);
            int firstButtonY = ClientSize.Height - BOTTOM_PADDING - buttonSize.Height;
        ...
        /// <summary>
        /// Gets the button control for the specified TextEntryMessageBoxButton, if the
        ...
        /// <returns></returns>
        private Button GetButton(TextEntryMessageBoxButton button, Size size, Point location) {
            Button buttonCtrl;
        ...
        /// <summary>
        /// Creates a button control based on info from TextEntryMessageBoxButton
        /// </summary>
        /// <param name="button"></param>
        /// <param name="size"></param>
        /// <param name="location"></param>
        /// <returns></returns>
        private Button CreateButton(TextEntryMessageBoxButton button, Size size, Point location) {
        ...
        private void DisableCloseIfMultipleButtonsAndNoCancelButton() {
            if (_buttons.Count > 1) {
                ...
                foreach (TextEntryMessageBoxButton button in _buttons) {
                    if (button.Text == TextEntryMessageBoxButtons.Cancel.ToString() && button.Value == TextEntryMessageBoxButtons.Cancel.ToString()) {
                ...
                _cancelButton = _buttons[0] as TextEntryMessageBoxButton;
            } else {
        ...
        private void timerTimeout_Tick(object sender, EventArgs e) {
            ...
            switch (_timeoutResult) {
                ...
                case TimeoutResult.Timeout:
                    SetResultAndClose(TextEntryMessageBoxResult.Timeout);
                    break;
            }
        }
        #endregion
